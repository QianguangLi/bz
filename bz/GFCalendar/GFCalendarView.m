...
- (instancetype)initWithFrameOrigin:(CGPoint)origin width:(CGFloat)width {
    ...
    if (self = [super initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight)]) {
        //self = [super initWithFrame:CGRectMake(origin.x, origin.y, width, _calendarHeight)]
...
//        self.layer.cornerRadius = 8.0;
        ...
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(origin.x, origin.y, width, _calendarHeight)];
        
        view.layer.masksToBounds = YES;
        view.layer.borderColor = kCalendarBasicColor.CGColor;
        view.layer.borderWidth = 2.0 / [UIScreen mainScreen].scale;
        view.layer.cornerRadius = 8.0;
        
        [self addSubview:view];
        
        [view addSubview:_calendarHeaderButton];
        [view addSubview:_weekHeaderView];
        [view addSubview:_calendarScrollView];
