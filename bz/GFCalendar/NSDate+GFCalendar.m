...
+ (BOOL)dateIsToday:(NSString *)dateString
{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:@"YYYY-MM-dd HH:mm:ss"];
    NSString *str = [dateFormatter stringFromDate:[NSDate date]];
    return [dateString hasPrefix:str];
}

+ (NSInteger)weekDayOfDateString:(NSString *)dateString
{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:@"YYYY-MM-dd HH:mm:ss"];
    ...
    return [calendar component:NSCalendarUnitWeekday fromDate:localeDate]-1;
}
